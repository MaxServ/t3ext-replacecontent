<?php
namespace MaxServ\Replacecontent\Tests\Functional;
 ...
 *
 * @package MaxServ\Replacecontent\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
     ...
     * @var array
     */
    protected $testExtensionsToLoad = ['typo3conf/ext/replacecontent'];
    ...
    public function templateIsRendered()
    {
        ...
        $expectedDom->loadHTML('<h1>MaxServ Replacecontent</h1>');
    ...
    protected function setUp()
    {
        ...
        $this->setUpFrontendRootPage(1, ['EXT:replacecontent/Tests/Functional/Fixtures/Frontend/Basic.ts']);
    }
